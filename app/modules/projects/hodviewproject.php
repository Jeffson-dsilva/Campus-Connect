                        ...
                        <form method="GET" action="" class="flex-1 sm:flex-none">
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                                    ...
                                    aria-label="Search">
                                <?php if (!empty($search)) : ?>
                                    <a href="hodviewproject.php" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form action="hodproject_details.php" method="GET" class="inline">
