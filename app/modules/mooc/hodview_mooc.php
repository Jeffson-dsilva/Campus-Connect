                        ...
                        <form method="GET" action="" class="flex-1 sm:flex-none">
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                                    ...
                                    aria-label="Search">
                                <?php if (!empty($search)) : ?>
                                    <a href="<?= BASE_URL ?>app/modules/mooc/hodview_mooc.php" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
            ...
            <div class="p-6">
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10 bg-indigo-100 rounded-full flex items-center justify-center">
                                                    <span class="text-indigo-600 font-medium"><?php echo substr(htmlspecialchars($row["usn"]), -3); ?></span>
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form action="<?= BASE_URL ?>app/modules/mooc/hodmooc_details.php" method="GET" class="inline">
                ...
                <?php else : ?>
                    <div class="text-center py-12">
                        ...
                        <?php if (!empty($search)) : ?>
                            <a href="<?= BASE_URL ?>app/modules/mooc/hodview_mooc.php" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between">
                        ...
                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            for ($i = $start_page; $i <= $end_page; $i++) {
                                $active = $i == $page ? 'bg-indigo-50 border-indigo-500 text-indigo-600' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50';
