                        ...
                        <form method="GET" action="" class="flex-1 sm:flex-none">
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                                    ...
                                    aria-label="Search">
                                <?php if (!empty($search)) : ?>
                                    <a href="<?= BASE_URL ?>app/modules/internships/hodviewinternship.php" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
            ...
            <div class="p-6">
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form action="<?= BASE_URL ?>app/modules/internships/hodview_details.php" method="GET" class="inline">
                ...
                <?php else : ?>
                    <div class="text-center py-12">
                        ...
                        <?php if (!empty($search)) : ?>
                            <a href="<?= BASE_URL ?>app/modules/internships/hodviewinternship.php" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
