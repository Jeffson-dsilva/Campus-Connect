...
require_once __DIR__ . '/../../views/ftheader.php';
?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="p-6 flex flex-col items-center text-center">
                ...
                <a href="<?= BASE_URL ?>app/modules/internships/ftviewinternship.php" class="w-full bg-blue-600 hover:bg-green-500 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="p-6 flex flex-col items-center text-center">
                ...
                <a href="<?= BASE_URL ?>app/modules/projects/ftviewproject.php" class="w-full bg-blue-600 hover:bg-green-500 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="p-6 flex flex-col items-center text-center">
                ...
                <a href="<?= BASE_URL ?>app/modules/mooc/ftviewmooc.php" class="w-full bg-blue-600 hover:bg-green-500 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="p-6 flex flex-col items-center text-center">
                ...
                <a href="<?= BASE_URL ?>app/modules/mentorship/ftviewmentorship.php" class="w-full bg-blue-600 hover:bg-green-500 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="p-6 flex flex-col items-center text-center">
                ...
                <a href="<?= BASE_URL ?>app/modules/classops/classops_dashboard.php" class="w-full bg-blue-600 hover:bg-green-500 text-white py-2 px-4 rounded-md text-sm font-medium transition-colors duration-300">
                    Access Portal
                </a>
            </div>
        </div>
