...
if (!isset($_SESSION['email'])) {
    header("Location: " . BASE_URL . "app/login.php");  // Redirect to login if not logged in
    exit();
}
...
<script>
    ...
    function closeModal() {
        ...
        window.location.href = '<?= BASE_URL ?>app/modules/dashboards/stDashboard.php'; // Redirect to dashboard after success
    }
